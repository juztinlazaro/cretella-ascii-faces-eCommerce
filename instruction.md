...
- Ads should be randomly selected, but a user must never see the same ad twice in a row.
  NOTE: I try my best to implement this feature 100% but sadly i don't have any time, i just created a workaround where in i generate a random numbers and when its even i will insert the ads in the data. hoping for consideration thanks.
